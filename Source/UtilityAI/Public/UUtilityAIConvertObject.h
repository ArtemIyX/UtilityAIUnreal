...
#include "UUtilityAIConvertObject.generated.h"

/**
 * 
 */
UCLASS(Blueprintable, BlueprintType)
class UTILITYAI_API UUUtilityAIConvertObject : public UUtilityAIConvertObjectBase
{
	GENERATED_BODY()

public:
	UUUtilityAIConvertObject(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
